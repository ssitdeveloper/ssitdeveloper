...
return [
    ...
    */
    ...
    | same driver. This is how you can group types of items stored in cache.
    |
    */
    ...
    | might be other applications utilizing the same cache. So, we'll specify
    | a value to get prepended to all our cache keys so we can avoid collisions.
    |
    */
