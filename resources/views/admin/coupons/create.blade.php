...
<div class="admin-content">
    ...
    <div class="card" style="background-color: var(--color-white); border: 1px solid var(--color-gray-200); border-radius: var(--radius-lg); padding: var(--spacing-4); max-width: 600px;">
        <h1 style="margin-top: 0; margin-bottom: var(--spacing-4); color: var(--color-gray-900);">Create New Coupon</h1>
        ...
        <form method="POST" action="{{ route('admin.coupons.store') }}" style="display: grid; gap: var(--spacing-4);">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="code" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;" placeholder="e.g., SAVE20">
            </div>
            ...
            <div>
                ...
                <input type="number" name="discount_value" step="0.01" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>

            <div>
                <label style="display: block; margin-bottom: var(--spacing-1); font-weight: var(--font-weight-medium);">Usage Limit</label>
                <input type="number" name="usage_limit" min="1" style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;" placeholder="Leave empty for unlimited">
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" name="valid_from" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" name="valid_until" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>
