...
<div class="admin-content">
    ...
    <div class="card" style="background-color: var(--color-white); border: 1px solid var(--color-gray-200); border-radius: var(--radius-lg); padding: var(--spacing-4); max-width: 600px;">
        <h1 style="margin-top: 0; margin-bottom: var(--spacing-4); color: var(--color-gray-900);">Edit Invoice</h1>
        ...
        <form method="POST" action="{{ route('admin.invoices.update', $invoice->id) }}" style="display: grid; gap: var(--spacing-4);">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="invoice_number" value="{{ $invoice->invoice_number }}" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" name="invoice_date" value="{{ $invoice->invoice_date->format('Y-m-d\TH:i') }}" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>
            ...
            <div>
                ...
                <input type="number" name="amount" step="0.01" value="{{ $invoice->amount }}" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
            </div>
            ...
            <div>
                ...
                <select name="status" required style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box;">
                    ...
                    <option value="issued" @if($invoice->status === 'issued') selected @endif>Issued</option>
            ...
            <div>
                ...
                <textarea name="notes" style="width: 100%; padding: var(--spacing-2); border: 1px solid var(--color-gray-300); border-radius: var(--radius-lg); box-sizing: border-box; min-height: 100px;">{{ $invoice->notes }}</textarea>
            </div>
