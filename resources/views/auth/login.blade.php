...
<head>
    ...
    <meta name="description" content="Login to NEET LMS - Medical entrance exam preparation platform">
    <title>Login - NEET LMS</title>
        ...
        <div class="auth-content">
            <div class="auth-form-container">
                <div class="auth-form-header">
                    <h1>Welcome Back</h1>
                    <p>Sign in to your NEET LMS account to continue your medical entrance exam preparation.</p>
                </div>
                ...
                <form id="loginForm" method="POST" action="{{ route('login') }}" class="auth-form">
                    ...
                    @if ($errors->any())
                        <div class="auth-error">
                            <svg style="width: 20px; height: 20px; flex-shrink: 0;" data-lucide="alert-circle"></svg>
                            <div>
                    ...
                    @if (session('status'))
                        <div class="auth-success">
                            <svg style="width: 20px; height: 20px; flex-shrink: 0;" data-lucide="check-circle"></svg>
                            {{ session('status') }}
                        </div>
                    @endif
                ...
                <div style="margin-top: var(--spacing-3); text-align: center; font-size: var(--font-size-sm);">
                    ...
                    <a href="{{ route('register') }}" style="font-weight: var(--font-weight-semibold);">Sign up here</a>
                </div>
            </div>
        </div>

        <div class="auth-bg">
            <h2>Master Your NEET Exam</h2>
            <p>Join thousands of medical students preparing for success with NEET LMS</p>

            <div style="margin-top: var(--spacing-5); text-align: center;">
                <div style="font-size: 3rem; margin-bottom: var(--spacing-2);">📚</div>
                <div style="color: rgba(255,255,255,0.9);">
                    <p style="margin-bottom: var(--spacing-1);"><strong>3,000+</strong> Practice Questions</p>
                    <p style="margin-bottom: var(--spacing-1);"><strong>100+</strong> Mock Tests</p>
                    <p><strong>Expert</strong> Guidance</p>
                </div>
            </div>
        </div>
    </div>
