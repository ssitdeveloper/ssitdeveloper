...
<?php $__env->startSection('title', 'Home - NEET LMS | Medical Entrance Exam Preparation'); ?>
<?php $__env->startSection('meta_description', 'NEET LMS - Master your medical entrance exam with 3,000+ questions, mock tests, and expert guidance. Join 50,000+ students preparing for success.'); ?>
...
<section class="hero">
    <div class="container">
        ...
        <div class="hero-buttons">
            ...
            <a href="<?php echo e(route('pricing')); ?>" class="btn btn-outline">View Plans</a>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container text-center">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-large" style="max-width: 300px; margin: 0 auto; display: block;">Get Started Today</a>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\neet\resources\views/home.blade.php ENDPATH**/ ?>